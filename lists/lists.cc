...
int strlnk::operator==(const char* chs) // return 0 if not equal
{
...
{
  double xx = 0.0;
  if ((strlnk_len == 0) || (str1 == 0)) return xx;
  istrstream* xxx = new istrstream(str1,strlnk_len);
  *xxx>>xx;
  return xx;
}
...
int strlnk::operator==(const strlnk& xstr) // return 0 if not equal
{
